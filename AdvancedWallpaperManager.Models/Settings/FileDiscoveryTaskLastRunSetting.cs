...
{
    public class FileDiscoveryTaskLastRunSetting : ApplicationSettingBase<DateTime>
    {
        ...
        public FileDiscoveryTaskLastRunSetting()
            : base(StorageTask.LocalSettings, "FileDiscoveryTaskLastRun", DateTime.MinValue)
        {
        }
