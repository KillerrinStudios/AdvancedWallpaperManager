...
{
    public class ActiveThemeTaskLastRunSetting : ApplicationSettingBase<DateTime>
    {
        ...
        public ActiveThemeTaskLastRunSetting()
            : base(StorageTask.LocalSettings, "ActiveThemeTaskLastRun", DateTime.MinValue)
        {
        }
