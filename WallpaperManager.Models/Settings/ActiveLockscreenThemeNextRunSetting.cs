...
{
    public class ActiveLockscreenThemeNextRunSetting : ApplicationSettingBase<DateTime>
    {
        ...
        public ActiveLockscreenThemeNextRunSetting()
            : base(StorageTask.LocalSettings, "ActiveLockscreenThemeNextRun", DateTime.MinValue)
        {
        }
