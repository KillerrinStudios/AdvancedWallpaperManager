...
{
    public class ActiveDesktopThemeLastRunSetting : ApplicationSettingBase<DateTime>
    {
        ...
        public ActiveDesktopThemeLastRunSetting()
            : base(StorageTask.LocalSettings, "ActiveDesktopThemeLastRun", DateTime.MinValue)
        {
        }
