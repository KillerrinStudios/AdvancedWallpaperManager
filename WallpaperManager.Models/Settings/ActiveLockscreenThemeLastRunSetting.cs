...
{
    public class ActiveLockscreenThemeLastRunSetting : ApplicationSettingBase<DateTime>
    {
        ...
        public ActiveLockscreenThemeLastRunSetting()
            : base(StorageTask.LocalSettings, "ActiveLockscreenThemeLastRun", DateTime.MinValue)
        {
        }
